...
sealed partial class MultiInstanceApiSuite
{
    ...
    {
        Console.WriteLine("Flowbit multi-instance API QA");
    ...
    private async Task EnvironmentReadyAsync(CaseScope scope)
    {
        ...
        scope.True(response.Body.Contains("Flowbit API", StringComparison.OrdinalIgnoreCase),
            "OpenAPI document contains the Flowbit title", Truncate(response.Body, 300));
        _apiReady = true;
    }
