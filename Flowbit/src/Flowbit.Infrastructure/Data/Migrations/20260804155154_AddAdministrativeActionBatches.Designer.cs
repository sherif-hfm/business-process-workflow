...
namespace Flowbit.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260804155154_AddAdministrativeActionBatches")]
    partial class AddAdministrativeActionBatches
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Flowbit.Infrastructure.Entities.AdministrativeActionBatchItemEntity", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CapturedUserTaskUpdatedAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Flowbit.Infrastructure.Entities.AdministrativeActionBatchItemEntity", b =>
                {
                    ...
                    b.HasOne("Flowbit.Infrastructure.Entities.UserTaskEntity", "NewUserTask")
                        .WithMany()
