...
namespace Flowbit.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260730175614_DetachResolvedIncidentsFromExpiredJobs")]
    partial class DetachResolvedIncidentsFromExpiredJobs
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Flowbit.Infrastructure.Entities.WorkflowJobEntity", b =>
                {
                    ...
                    b.HasIndex("Status", "LeaseExpiresAt", "Id")
                    ...
                    b.HasIndex("Status", "QueueClass", "DueAt", "Priority", "Id")
